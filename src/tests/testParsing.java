...
public class testParsing {
	...
	private static List<NameValuePair> MakeChallengeParams(String url)
		...
		paramList.add(new BasicNameValuePair("challenge_response", URLEncoder.encode("25242875@mail.ru", "UTF-8")));
		return paramList;
	}
	...
	public static void main(String args[]) throws Exception {
		// MakeUProxy();
		String html = "<html><body>You are being <a href=https://twitter.com/account/login_challenge?platform=web&amp;user_id=2424398037&amp;challenge_type=RetypeEmail&amp;challenge_id=kZ3H3dYz3Zt1s3yM3m1gHJst7PxAFz2W&amp;remember_me=false&amp;redirect_after_login_verification=%2F>redirected</a>.</body></html>";
		String url = GetChallengeUrl(html);
		List<NameValuePair> params = MakeChallengeParams(url);
